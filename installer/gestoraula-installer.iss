...
#define WEB_VIEW "web-view"
#define APP_PATH "C:\Gestor_Aula_CloudLabs"
...
[Files]
Source: "{#SourcePath}\{#MyAppIcon}"; DestDir: "{#APP_PATH}"; Flags: ignoreversion
...
; SERVER FILES
Source: "{#SourcePath}\installers\{#NODE64}"; DestDir: "{#APP_PATH}"; Flags: ignoreversion
Source: "{#SourcePath}\installers\{#NSSM64}"; DestDir: "{#APP_PATH}"; Flags: ignoreversion
Source: "{#SourcePath}\installers\{#NSSM32}"; DestDir: "{#APP_PATH}"; Flags: ignoreversion
Source: "{#SourcePath}\batch\{#SERV_INI_BAT}"; DestDir: "{#APP_PATH}"; Flags: ignoreversion
Source: "{#SourcePath}\{#MyAppShortName}\*"; DestDir: "{#APP_PATH}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#SourcePath}\{#WEB_VIEW}\*"; DestDir: "{#APP_PATH}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
; SERVER
Filename: "{sys}\msiexec.exe"; Parameters: "/passive /i ""{#APP_PATH}\{#NODE}""";
...
Filename: "{#APP_PATH}\{#NSSM}"; Parameters: "install {#MyAppShortName} ""{pf64}\nodejs\node.exe"" ""{#APP_PATH}\bin\server.js"""; Flags: runhidden;
Filename: "{sys}\net.exe"; Parameters: "start {#MyAppShortName}"; Flags: runhidden;

[UninstallRun]
Filename: "{sys}\net.exe"; Parameters: "stop {#MyAppShortName}"; Flags: runhidden;
Filename: "{#APP_PATH}\{#NSSM}"; Parameters: "remove {#MyAppShortName} confirm"; Flags: runhidden;
...
Filename: "{sys}\msiexec.exe"; Parameters: "/passive /x ""{#APP_PATH}\{#NODE}""";

Filename: "{sys}\rmdir"; Parameters: "-r ""{#APP_PATH}""";
